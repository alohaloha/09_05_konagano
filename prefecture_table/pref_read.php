...
if ($status == false) {
  ...
  foreach ($result as $record) {
    ...
    // edit deleteリンクを追加
    $output .= "<td><a href ='pref_detail.php?id={$record["id"]}'>詳細情報</a></td>";
    $output .= "<td><a href ='pref_edit.php?id={$record["id"]}'>編集する</a></td>";
    $output .= "<td><a href ='pref_delete.php?id={$record["id"]}'>削除する</a></td>";
